...
class User(db.Model):
    ...
    favorites = db.relationship('Favorites', backref='favorites', cascade='all, delete')

    user_comments = db.relationship('Comment_Recipe', backref='comments_recipes', cascade='all, delete')
