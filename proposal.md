...
What goal will your website be designed to achieve?
  ...
  >This website will allow users to search and save recipes based on category and/or ingredients.
----
...
What data do you plan on using? You may have not picked your actual API yet, which is fine, just outline what kind of data you would like it to contain.
  ...
  >This site will use the BigOven API (https://api2.bigoven.com/).  Through this API users will have access to recipe ingredients and instructions.
----
...
1. What kinds of issues might you run into with your API?
  ...
  >Ensuring user categories align with API categories - creating a drop down list of options for users to select

1. Is there any sensitive information you need to secure?
  >1. User password information
  >1. Only logged in users will be able to create a favorites list
  >1. Only logged in users will be able to create (and possible view) comments

1. What functionality will your app include?
  >1. Log in / Registration of users
  >1. Recipe search by category or ingredient
  >1. Users can save recipes to a favorites list
  >1. Users can add comments to recipes

1. What will the user flow look like?
...
6. What features make your site more than CRUD? Do you have any stretch goals?
  ...
  > 1. Stretch goal: Search based on multuple ingredients and categories
